<template>
  <div
    id="slider"
    class="column-gap relative mt-[10%] grid w-full grid-cols-12 gap-2 max-md:min-h-svh lg:h-[110svh]"
  >
    ...
    <template v-if="!isSmallScreen">
      ...
      >
        ...
        <div class="relative flex h-full items-end justify-between">
          ...
          >
            <div
              class="sticky top-[10%] flex place-content-end gap-3 lg:will-change-scroll"
            >
      ...
      >
        <img
          ...
          class="relative z-10 size-full rounded-lg object-cover object-center mix-blend-screen brightness-90 grayscale lg:h-[110svh]"
